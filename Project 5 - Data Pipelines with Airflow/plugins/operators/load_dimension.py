...
class LoadDimensionOperator(BaseOperator):
    ...
    loading_type (string): The 'delete-load' (default) option will drop-and-swap load the data.  The 'append' option will append new data to the existing data
    '''
